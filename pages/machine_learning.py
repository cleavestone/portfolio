...
# Display an example plot of predicted vs actual PM2.5
st.image("assets/project_visuals/image111.png", caption="Predicted vs Actual PM2.5 Concentration", use_container_width=True)

# Optionally, add more images or visualizations for seasonal decomposition, forecast plots etc.
